...
class LetterBTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: BDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_b_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the vertical line of 'B'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Awesome! Letter 'B' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the top curve of 'B'"
                        2 -> instructionText.text = "Step 3: Trace the bottom curve of 'B'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterCTracingActivity::class.java)
