...
class CDotDrawingView @JvmOverloads constructor(
    ...
    private fun createCHintPath(width: Float, height: Float) {
        val centerX = width / 2
        ...
        hintPath.addArc(rect, 45f, 270f) // Arc to draw the letter C
    }
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        createCHintPath(w.toFloat(), h.toFloat())
    }
