...
class LetterRTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: RDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_r_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the vertical line of 'R'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Great! Letter 'R' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the top curve of 'R'"
                        2 -> instructionText.text = "Step 3: Trace the diagonal leg of 'R'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterSTracingActivity::class.java)
