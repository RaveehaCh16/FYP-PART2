...
class ZDotDrawingView @JvmOverloads constructor(
    ...
    private fun setupSteps(width: Float, height: Float) {
        ...
        // Define the three strokes of letter Z

        // Step 1: Top horizontal line (left to right)
        val step1 = Path().apply {
            moveTo(width / 6, height / 6)
            lineTo(width * 5 / 6, height / 6)
        }

        // Step 2: Diagonal line (top right to bottom left)
        val step2 = Path().apply {
            moveTo(width * 5 / 6, height / 6)
            lineTo(width / 6, height * 5 / 6)
        }

        // Step 3: Bottom horizontal line (left to right)
        val step3 = Path().apply {
            moveTo(width / 6, height * 5 / 6)
            lineTo(width * 5 / 6, height * 5 / 6)
        }
