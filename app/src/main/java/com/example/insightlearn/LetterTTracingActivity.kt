...
class LetterTTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: TDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_t_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the top horizontal line of 'T'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Awesome! Letter 'T' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the vertical stem of 'T'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterUTracingActivity::class.java)
