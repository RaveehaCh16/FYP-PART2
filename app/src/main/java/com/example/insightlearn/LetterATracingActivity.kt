...
class LetterATracingActivity : AppCompatActivity() {

    private lateinit var drawingView: DotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_a_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the left slant line of 'A'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Great! Letter 'A' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the right slant line of 'A'"
                        2 -> instructionText.text = "Step 3: Trace the crossbar of 'A'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterBTracingActivity::class.java)
