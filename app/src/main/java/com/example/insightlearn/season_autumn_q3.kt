...
class AutumnQuestionActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.autumn_qs3)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is 3", Toast.LENGTH_SHORT).show()
        }
