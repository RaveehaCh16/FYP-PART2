...
class SpringQuestionActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.spring_q2)
        ...
        nextButton.setOnClickListener {
            if (answerSelected) {
                val intent = Intent(this, SpringQuestionActivity3::class.java)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is Daisy", Toast.LENGTH_SHORT).show()
        }
