...
class SummerQuestionActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.summer_qs3)
        ...
        nextButton.setOnClickListener {
            if (answerSelected) {
                val intent = Intent(this, SpringStoryActivity ::class.java)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is Crab", Toast.LENGTH_SHORT).show()
        }
