...
class LetterLTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: LDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_l_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the vertical line of 'L'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Great! Letter 'L' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the horizontal line of 'L'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterMTracingActivity::class.java)
