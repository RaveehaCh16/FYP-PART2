...
class SpeechTest3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val test4Button = findViewById<Button>(R.id.test4Button)  // Reference to test2Button
        ...
        test4Button.setOnClickListener {
            val intent = Intent(this, SpeechTest4Activity::class.java)  // Create an intent to navigate to SpeechTest2Activity
