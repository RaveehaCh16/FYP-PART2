...
class QDotDrawingView @JvmOverloads constructor(
    ...
    private fun setupSteps(width: Float, height: Float) {
        ...
        // Tail (diagonal line at bottom-right of the circle)
        val step2 = Path().apply {
            val tailStartX = centerX + radius / 2
            val tailStartY = centerY + radius / 2
            moveTo(tailStartX, tailStartY)
            lineTo(tailStartX + 80f, tailStartY + 80f)
        }
