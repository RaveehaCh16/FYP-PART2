...
class LetterSTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: SDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_s_tracing)
        ...
        // Initial setup
        instructionText.text = "Step 1: Trace the top curve of 'S'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Great! Letter 'S' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the bottom curve of 'S'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterTTracingActivity::class.java)
        ...
        // Pass touch events to custom view
