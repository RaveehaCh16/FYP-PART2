...
class LetterYTracingActivity : AppCompatActivity() {

    private lateinit var drawingView: YDotDrawingView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_y_tracing)
        ...
        // Initial state
        instructionText.text = "Step 1: Trace the left diagonal line of 'Y'"
        ...
        drawingView.stepCompletedListener = { isFinished ->
            runOnUiThread {
                if (isFinished) {
                    instructionText.text = "🎉 Awesome! Letter 'Y' completed!"
                    ...
                    when (drawingView.currentStep) {
                        1 -> instructionText.text = "Step 2: Trace the right diagonal line of 'Y'"
                        2 -> instructionText.text = "Step 3: Trace the vertical line of 'Y'"
                    }
                }
            }
        }
        ...
        nextButton.setOnClickListener {
            if (drawingView.isCompleted()) {
                val intent = Intent(this, LetterZTracingActivity::class.java)
