...
class SpringQuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.spring_qs)
        ...
        nextButton.setOnClickListener {
            if (answerSelected) {
                val intent = Intent(this, SpringQuestionActivity2::class.java)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is Yellow", Toast.LENGTH_SHORT).show()
        }
