...
class SpringQuestionActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.spring_qs3)
        ...
        nextButton.setOnClickListener {
            if (answerSelected) {
                val intent = Intent(this, AutumnStoryActivity::class.java)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is Rabbit", Toast.LENGTH_SHORT).show()
        }
