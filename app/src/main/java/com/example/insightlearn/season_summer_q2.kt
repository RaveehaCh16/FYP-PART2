...
class SummerQuestionActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.summer_qs2)
        ...
        nextButton.setOnClickListener {
            if (answerSelected) {
                val intent = Intent(this, SummerQuestionActivity3::class.java)
    ...
    private fun handleAnswerSelection(selectedButton: Button, correct: Boolean) {
        ...
        if (correct) {
            ...
            Toast.makeText(this, "Oops! Wrong Answer, the correct answer is Icecream", Toast.LENGTH_SHORT).show()
        }
